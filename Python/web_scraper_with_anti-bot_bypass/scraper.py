from playwright.sync_api import sync_playwright # imports playwright fro browser automation
...
def get_page_content(url): #function to fetch HTML page content from a url
    with sync_playwright() as p:
        ...
        page.wait_for_selector(".product_pod") # waits until elements with class .product load
